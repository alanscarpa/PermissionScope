...
@objc public class PermissionScope: UIViewController, UIGestureRecognizerDelegate {
    ...
    // MARK: - UserDefaults lazy manager
    ...
    // MARK: - Default status for Core Motion Activity
    ...
    */
    func permissionStyledButton(_ type: PermissionType) -> UIButton {
        ...
        let title = type.isALocationType ? "Enable \(type.prettyDescription)".localized.uppercased() : "Allow \(type)".localized.uppercased()
